...
String _$onlineUsersHash() => r'084d20a8c661396e7673c7f82decd37bfca870e0';

/// See also [OnlineUsers].
@ProviderFor(OnlineUsers)
final onlineUsersProvider =
    NotifierProvider<OnlineUsers, List<String>>.internal(
  OnlineUsers.new,
...
typedef _$OnlineUsers = Notifier<List<String>>;
